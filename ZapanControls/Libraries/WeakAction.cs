...
namespace ZapanControls.Libraries
{
    ...
    {
        // Source : https://github.com/lbugnion/mvvmlight/blob/1f67dfbcfb776b785727c1505566dc5f7c72a891/GalaSoft.MvvmLight/GalaSoft.MvvmLight%20(PCL)/Helpers/WeakAction.cs
        ...
        public WeakAction(object target, Action action, bool keepTargetAlive = false)
        {
            ...
            if (ActionReference != null && ActionReference.Target != null && !keepTargetAlive)
            {
                ...
                if (type.Name.StartsWith("<>", StringComparison.InvariantCultureIgnoreCase)
