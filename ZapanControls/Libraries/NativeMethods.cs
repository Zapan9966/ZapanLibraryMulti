...
namespace ZapanControls.Libraries
{
    public static class NativeMethods
    {
        ...
        // https://blog.onedevjob.com/2010/10/19/fixing-full-screen-wpf-windows/
        ...
        public static IntPtr MaximizedSizeFixWindowProc(
            IntPtr hwnd,
            int msg,
            IntPtr wParam,
            IntPtr lParam,
        ...
        {
            ZapWindow win = (ZapWindow)(HwndSource.FromHwnd(hwnd).RootVisual);
            ...
            if (monitor != IntPtr.Zero)
            {
                ...
                // The display working area.
                RECT rcWorkArea = monitorInfo.WorkArea;

                // Get window information
                WINDOWINFO windowInfo = new WINDOWINFO { Size = (UInt32)(Marshal.SizeOf(typeof(WINDOWINFO))) };
                ...
                // Set maximum size to the size of the window in maximized state
                mmi.MinTrackSize.X = Convert.ToInt32(win.MinWidth);
                mmi.MinTrackSize.Y = Convert.ToInt32(win.MinHeight);
