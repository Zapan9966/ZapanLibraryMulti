...
namespace ZapanControls.Libraries
{
    ...
    public abstract class ObservableObject : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public bool Set<T>(ref T oldValue, T newValue, [CallerMemberName] String propertyName = null)
            => Set(propertyName, ref oldValue, newValue);
        ...
        public bool Set<T>(Expression<Func<T>> propertyNameExpression, ref T oldValue, T newValue)
            => Set(ExpressionUtilities.GetPropertyName(propertyNameExpression), ref oldValue, newValue);
        ...
        public string DataValidationMessages()
        {
            ...
            {
                builder.Append(this[property.Name] != null ? $" - {this[property.Name]}\r\n" : string.Empty);
            }
